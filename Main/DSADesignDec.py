...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.labelDSA = QtWidgets.QLabel(parent=Form)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.labelDSA.setFont(font)
        self.labelDSA.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.labelDSA.setMinimumSize(QtCore.QSize(250, 100))
        self.labelDSA.setObjectName("labelDSA")
        self.gridLayout.addWidget(self.labelDSA, 0, 2, 1, 7)
    ...
    def retranslateUi(self, Form):
        ...
        self.labelDSA.setText(_translate("Form", "Расшифрование по алгоритму DSA"))
